...
class Utils:
    ...
    def save_confusion_matrix_excel(
        ...
        for item in confusion_matrix:
            ...
            row.append(confusion_matrix.tp_per_classes[i])
            row.append(confusion_matrix.fp_per_classes[i])
            row.append(confusion_matrix.fn_per_classes[i])
            row.append(confusion_matrix.tn_per_classes[i])
